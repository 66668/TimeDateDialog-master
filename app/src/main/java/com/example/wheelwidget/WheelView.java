...
package com.example.wheelwidget;
...
import com.example.adapter.WheelViewAdapter;
import com.example.wheelviewListener.OnWheelChangedListener;
import com.example.wheelviewListener.OnWheelClickedListener;
import com.example.wheelviewListener.OnWheelScrollListener;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheelview_date_val);
		}
...
//		setBackgroundResource(R.drawable.wheel_date_bg);//背景图
	}
